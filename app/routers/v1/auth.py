...
async def login_access_token(
    ...
    return BaseResponse(data=LoginAdminResponse(
        access_token=token,
        token_type="bearer",
...
async def register_customer(customer_in: CustomerCreate, db: AsyncSession = Depends(get_db)) -> BaseResponse[CustomerResponse]:
...
async def login_customer(
    ...
    return BaseResponse(data=LoginCustomerResponse(
        access_token=token,
        token_type="bearer",
