...
class Product(Base, TimestampMixin):
    ...
    category_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("Category.category_id"), nullable=False)
    description: Mapped[Optional[str]] = mapped_column(UnicodeText, nullable=True)
    gender_target: Mapped[Optional[str]] = mapped_column(Enum("men", "women", "unisex", "kids", "male", "female"), nullable=True)
    ...
    colors: Mapped[list["ProductColor"]] = relationship("ProductColor", back_populates="product", lazy="selectin")
